!(function(e) {
  ...
  function(e, t, r) {
    ...
    function o(e, t, r) {
      if (null !== e)
        for (
          ...
          (c = h ? e.features[g].geometry : y ? e.geometry : e),
            (d = !!c && 'GeometryCollection' === c.type),
            (l = d ? c.geometries.length : 1);
          for (var v = 0; v < l; v++) {
            var _ = 0,
              j = 0;
            if (null !== (i = d ? c.geometries[v] : c)) {
              u = i.coordinates;
              var M = i.type;
              switch (((p = !r || ('Polygon' !== M && 'MultiPolygon' !== M) ? 0 : 1), M)) {
                case null:
                  break;
                case 'Point':
                  if (!1 === t(u, f, g, _, j)) return !1;
                  f++, _++;
                  break;
                case 'LineString':
                case 'MultiPoint':
                  for (n = 0; n < u.length; n++) {
                    if (!1 === t(u[n], f, g, _, j)) return !1;
                    f++, 'MultiPoint' === M && _++;
                  }
                  'LineString' === M && _++;
                  break;
                  ...
                  for (n = 0; n < u.length; n++) {
                    for ('MultiPolygon' === M && (j = 0), a = 0; a < u[n].length; a++) {
                      for (s = 0; s < u[n][a].length - p; s++) {
                        if (!1 === t(u[n][a][s], f, g, _, j)) return !1;
                        f++;
                      }
                      j++;
                    }
    ...
    function n(e, t) {
      var r,
        ...
        m = 'Feature' === e.type,
        h = f ? e.features.length : 1;
      for (r = 0; r < h; r++) {
        for (
          i = f ? e.features[r].geometry : m ? e.geometry : e,
            u = f ? e.features[r].properties : m ? e.properties : {},
            c = f ? e.features[r].bbox : m ? e.bbox : void 0,
            d = f ? e.features[r].id : m ? e.id : void 0,
  ...
  function(e, t, r) {
    ...
    var n = r(31),
      ...
      b = (0, a.default)(h.controlTemplate, y),
      g = (0, a.default)(h.resultsTemplate, y),
      v = (0, a.default)(h.pointPopupTemplate, y),
      _ = (0, a.default)(h.linePopupTemplate, y),
      j = (0, a.default)(h.areaPopupTemplate, y);
    (L.Control.Measure = L.Control.extend({
      ...
      _getMeasurementDisplayStrings: function(e) {
        ...
        function r(e, t, r, o) {
          ...
          return [
            (0, m.numberFormat)(e * a.factor, a.decimals, r || ',', o || '.'),
  ...
  function(e, t, r) {
    function o(e, t, r) {
      var o = f.imports._.templateSettings || f;
      ...
      e.replace(P, function(t, r, o, n, a, s) {
        return (
          o || (o = n),
          (C += e.slice(x, s).replace(_, l)),
          r && ((j = !0), (C += "' +\n__e(" + r + ") +\n'")),
          a && ((M = !0), (C += "';\n" + a + ";\n__p += '")),
          o && (C += "' +\n((__t = (" + o + ")) == null ? '' : __t) +\n'"),
          (x = s + t.length),
      ...
      var S = t.variable;
      S || (C = 'with (obj) {\n' + C + '\n}\n'),
        (C = (M ? C.replace(h, '') : C).replace(y, '$1').replace(b, '$1;')),
        (C =
          'function(' +
          (S || 'obj') +
          ') {\n' +
          ...
          'return __p\n}');
      var A = a(function() {
        return Function(k, E + 'return ' + C).apply(void 0, w);
      });
      if (((A.source = C), u(A))) throw A;
      return A;
    }
    var n = r(32),
      a = r(62),
  ...
  function(e, t, r) {
    function o(e) {
      return !(!s(e) || a(e)) && (n(e) ? m : u).test(i(e));
    }
    var n = r(10),
      a = r(40),
      s = r(2),
