!(function(e) {
            ...
            if (null !== (i = d ? c.geometries[v] : c)) {
              ...
              switch (((f = !r || ('Polygon' !== M && 'MultiPolygon' !== M) ? 0 : 1), M)) {
                case null:
                  break;
                case 'Point':
                  if (!1 === t(l, p, g, _, j)) return !1;
                  p++, _++;
                  break;
                case 'LineString':
                case 'MultiPoint':
                  for (n = 0; n < l.length; n++) {
                    if (!1 === t(l[n], p, g, _, j)) return !1;
                    p++, 'MultiPoint' === M && _++;
                  }
                  'LineString' === M && _++;
                  break;
                ...
                case 'MultiPolygon':
                  for (n = 0; n < l.length; n++) {
                    for ('MultiPolygon' === M && (j = 0), a = 0; a < l[n].length; a++) {
                      for (s = 0; s < l[n][a].length - f; s++) {
                        if (!1 === t(l[n][a][s], p, g, _, j)) return !1;
                        p++;
                      }
                      j++;
                    }
  ...
  function(e, t, r) {
    ...
    var n = r(31),
      ...
      j = (0, a.default)(m.areaPopupTemplate, y);
