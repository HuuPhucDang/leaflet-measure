!(function(e) {
            ...
            if (null !== (i = d ? c.geometries[g] : c)) {
              ...
              switch (((p = !r || ('Polygon' !== j && 'MultiPolygon' !== j) ? 0 : 1), j)) {
                ...
                case 'MultiLineString':
                  for (n = 0; n < u.length; n++) {
                    for (s = 0; s < u[n].length - p; s++) {
                      if (!1 === t(u[n][s], f, v, _, M)) return !1;
                      f++;
                    }
                ...
                case 'MultiPolygon':
                  for (n = 0; n < u.length; n++) {
                    for ('MultiPolygon' === j && (M = 0), s = 0; s < u[n].length; s++) {
                      for (a = 0; a < u[n][s].length - p; a++) {
                        if (!1 === t(u[n][s][a], f, v, _, M)) return !1;
                        f++;
                      }
                      M++;
                    }
        ...
        for (
          ...
          if (null !== (s = l ? i.geometries[n] : i))
            switch (s.type) {
              ...
              case 'MultiLineString':
              case 'MultiPolygon':
                if (!1 === t(s, p, u, c, d)) return !1;
                break;
              case 'GeometryCollection':
                for (o = 0; o < s.geometries.length; o++)
                  if (!1 === t(s.geometries[o], p, u, c, d)) return !1;
                break;
              default:
                throw new Error('Unknown Geometry Type');
            }
  ...
  function(e, t, r) {
    ...
    var n = r(31),
      ...
      M = (0, s.default)(h.areaPopupTemplate, y);
  ...
  function(e, t, r) {
    ...
    function o(e, t, r) {
      ...
      return Object(s.g)(2 * Math.atan2(Math.sqrt(p), Math.sqrt(1 - p)), o);
    }
    var n = r(83),
      s = r(3);
    t.a = o;
