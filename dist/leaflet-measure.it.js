!(function(e) {
            ...
            if (null !== (i = f ? c.geometries[v] : c)) {
              ...
              switch (((d = !r || ('Polygon' !== j && 'MultiPolygon' !== j) ? 0 : 1), j)) {
                case null:
                  break;
                case 'Point':
                  if (!1 === t(l, p, g, _, M)) return !1;
                  p++, _++;
                  break;
                case 'LineString':
                case 'MultiPoint':
                  for (n = 0; n < l.length; n++) {
                    if (!1 === t(l[n], p, g, _, M)) return !1;
                    p++, 'MultiPoint' === j && _++;
                  }
                  'LineString' === j && _++;
                  break;
                ...
                case 'MultiLineString':
                  for (n = 0; n < l.length; n++) {
                    for (a = 0; a < l[n].length - d; a++) {
                      if (!1 === t(l[n][a], p, g, _, M)) return !1;
                      p++;
                    }
                ...
                case 'MultiPolygon':
                  for (n = 0; n < l.length; n++) {
                    for ('MultiPolygon' === j && (M = 0), a = 0; a < l[n].length; a++) {
                      for (s = 0; s < l[n][a].length - d; s++) {
                        if (!1 === t(l[n][a][s], p, g, _, M)) return !1;
                        p++;
                      }
                      M++;
                    }
        ...
        for (
          ...
          if (null !== (a = u ? i.geometries[n] : i))
            switch (a.type) {
              ...
              case 'MultiLineString':
              case 'MultiPolygon':
                if (!1 === t(a, d, l, c, f)) return !1;
                break;
              case 'GeometryCollection':
                for (o = 0; o < a.geometries.length; o++)
                  if (!1 === t(a.geometries[o], d, l, c, f)) return !1;
                break;
              default:
                throw new Error('Unknown Geometry Type');
            }
  ...
  function(e, t, r) {
    ...
    var n = r(31),
      ...
      g = (0, a.default)(m.resultsTemplate, y),
      v = (0, a.default)(m.pointPopupTemplate, y),
  ...
  function(e, t, r) {
    ...
    function o(e, t, r) {
      ...
      return Object(a.g)(2 * Math.atan2(Math.sqrt(d), Math.sqrt(1 - d)), o);
    }
    var n = r(83),
      a = r(3);
    t.a = o;
    ...
    function s(e) {
      ...
      if (f > 2) {
        for (u = 0; u < f; u++)
          u === f - 2
            ? ((n = f - 2), (a = f - 1), (s = 0))
            : u === f - 1 ? ((n = f - 1), (a = 0), (s = 1)) : ((n = u), (a = u + 1), (s = u + 2)),
            (t = e[n]),
            (r = e[a]),
            (o = e[s]),
