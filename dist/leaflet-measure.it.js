            ...
            if (null !== (i = d ? c.geometries[v] : c)) {
              ...
              switch (((f = !r || ('Polygon' !== j && 'MultiPolygon' !== j) ? 0 : 1), j)) {
                case null:
                  break;
                case 'Point':
                  if (!1 === t(u, p, g, _, M)) return !1;
                  p++, _++;
                  break;
                case 'LineString':
                case 'MultiPoint':
                  for (n = 0; n < u.length; n++) {
                    if (!1 === t(u[n], p, g, _, M)) return !1;
                    p++, 'MultiPoint' === j && _++;
                  }
                  'LineString' === j && _++;
                  break;
                ...
                case 'MultiLineString':
                  for (n = 0; n < u.length; n++) {
                    for (a = 0; a < u[n].length - f; a++) {
                      if (!1 === t(u[n][a], p, g, _, M)) return !1;
                      p++;
                    }
                ...
                case 'MultiPolygon':
                  for (n = 0; n < u.length; n++) {
                    for ('MultiPolygon' === j && (M = 0), a = 0; a < u[n].length; a++) {
                      for (s = 0; s < u[n][a].length - f; s++) {
                        if (!1 === t(u[n][a][s], p, g, _, M)) return !1;
                        p++;
                      }
                      M++;
                    }
        ...
        for (
          ...
          if (null !== (a = l ? i.geometries[n] : i))
            switch (a.type) {
              ...
              case 'MultiLineString':
              case 'MultiPolygon':
                if (!1 === t(a, f, u, c, d)) return !1;
                break;
              case 'GeometryCollection':
                for (o = 0; o < a.geometries.length; o++)
                  if (!1 === t(a.geometries[o], f, u, c, d)) return !1;
                break;
              default:
                throw new Error('Unknown Geometry Type');
            }
