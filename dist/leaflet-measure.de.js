!(function(e) {
            ...
            if (null !== (i = d ? c.geometries[v] : c)) {
              ...
              switch (((f = !r || ('Polygon' !== j && 'MultiPolygon' !== j) ? 0 : 1), j)) {
                ...
                case 'MultiLineString':
                  for (n = 0; n < l.length; n++) {
                    for (s = 0; s < l[n].length - f; s++) {
                      if (!1 === t(l[n][s], p, g, _, M)) return !1;
                      p++;
                    }
                ...
                case 'MultiPolygon':
                  for (n = 0; n < l.length; n++) {
                    for ('MultiPolygon' === j && (M = 0), s = 0; s < l[n].length; s++) {
                      for (a = 0; a < l[n][s].length - f; a++) {
                        if (!1 === t(l[n][s][a], p, g, _, M)) return !1;
                        p++;
                      }
                      M++;
                    }
        ...
        for (
          ...
          if (null !== (s = u ? i.geometries[n] : i))
            switch (s.type) {
              ...
              case 'MultiLineString':
              case 'MultiPolygon':
                if (!1 === t(s, f, l, c, d)) return !1;
                break;
              case 'GeometryCollection':
                for (o = 0; o < s.geometries.length; o++)
                  if (!1 === t(s.geometries[o], f, l, c, d)) return !1;
                break;
              default:
                throw new Error('Unknown Geometry Type');
            }
  ...
  function(e, t, r) {
    ...
    var n = r(31),
      ...
      g = (0, s.default)(m.resultsTemplate, y),
      v = (0, s.default)(m.pointPopupTemplate, y),
  ...
  function(e, t, r) {
    function o(e, t, r) {
      ...
      e.replace(E, function(t, r, o, n, s, a) {
        return (
          o || (o = n),
      ...
      A || (P = 'with (obj) {\n' + P + '\n}\n'),
        ...
        (P =
          ...
          'return __p\n}');
      var S = s(function() {
        return Function(k, C + 'return ' + P).apply(void 0, w);
      });
    ...
    function a(e) {
      ...
      if (d > 2) {
        for (u = 0; u < d; u++)
          u === d - 2
            ? ((n = d - 2), (s = d - 1), (a = 0))
            : u === d - 1 ? ((n = d - 1), (s = 0), (a = 1)) : ((n = u), (s = u + 1), (a = u + 2)),
            (t = e[n]),
            (r = e[s]),
            (o = e[a]),
