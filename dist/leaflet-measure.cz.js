!(function(e) {
            ...
            if (null !== (i = d ? c.geometries[g] : c)) {
              ...
              switch (((f = !r || ('Polygon' !== M && 'MultiPolygon' !== M) ? 0 : 1), M)) {
                case null:
                  break;
                case 'Point':
                  if (!1 === t(l, p, v, _, j)) return !1;
                  p++, _++;
                  break;
                case 'LineString':
                case 'MultiPoint':
                  for (n = 0; n < l.length; n++) {
                    if (!1 === t(l[n], p, v, _, j)) return !1;
                    p++, 'MultiPoint' === M && _++;
                  }
                  'LineString' === M && _++;
                  break;
                ...
                case 'MultiPolygon':
                  for (n = 0; n < l.length; n++) {
                    for ('MultiPolygon' === M && (j = 0), s = 0; s < l[n].length; s++) {
                      for (a = 0; a < l[n][s].length - f; a++) {
                        if (!1 === t(l[n][s][a], p, v, _, j)) return !1;
                        p++;
                      }
                      j++;
                    }
  ...
  function(e, t, r) {
    function o(e, t, r) {
      ...
      var S = t.variable;
      S || (P = 'with (obj) {\n' + P + '\n}\n'),
        (P = (M ? P.replace(m, '') : P).replace(y, '$1').replace(b, '$1;')),
        (P =
          'function(' +
          (S || 'obj') +
          ') {\n' +
