!(function(e) {
            ...
            if (null !== (i = d ? c.geometries[v] : c)) {
              ...
              switch (((p = !r || ('Polygon' !== j && 'MultiPolygon' !== j) ? 0 : 1), j)) {
                case null:
                  break;
                case 'Point':
                  if (!1 === t(u, f, g, _, M)) return !1;
                  f++, _++;
                  break;
                case 'LineString':
                case 'MultiPoint':
                  for (n = 0; n < u.length; n++) {
                    if (!1 === t(u[n], f, g, _, M)) return !1;
                    f++, 'MultiPoint' === j && _++;
                  }
                  'LineString' === j && _++;
                  break;
                  ...
                  for (n = 0; n < u.length; n++) {
                    for ('MultiPolygon' === j && (M = 0), a = 0; a < u[n].length; a++) {
                      for (s = 0; s < u[n][a].length - p; s++) {
                        if (!1 === t(u[n][a][s], f, g, _, M)) return !1;
                        f++;
                      }
                      M++;
                    }
  ...
  function(e, t, r) {
    function o(e, t, r) {
      ...
      var S = t.variable;
      S || (O = 'with (obj) {\n' + O + '\n}\n'),
        (O = (j ? O.replace(h, '') : O).replace(y, '$1').replace(b, '$1;')),
        (O =
          'function(' +
          (S || 'obj') +
          ') {\n' +
