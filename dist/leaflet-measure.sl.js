!(function(e) {
            ...
            if (null !== (i = d ? c.geometries[g] : c)) {
              ...
              switch (((f = !r || ('Polygon' !== M && 'MultiPolygon' !== M) ? 0 : 1), M)) {
                case null:
                  break;
                case 'Point':
                  if (!1 === t(u, p, b, _, j)) return !1;
                  p++, _++;
                  break;
                case 'LineString':
                case 'MultiPoint':
                  for (n = 0; n < u.length; n++) {
                    if (!1 === t(u[n], p, b, _, j)) return !1;
                    p++, 'MultiPoint' === M && _++;
                  }
                  'LineString' === M && _++;
                  break;
                  ...
                  for (n = 0; n < u.length; n++) {
                    for ('MultiPolygon' === M && (j = 0), a = 0; a < u[n].length; a++) {
                      for (s = 0; s < u[n][a].length - f; s++) {
                        if (!1 === t(u[n][a][s], p, b, _, j)) return !1;
                        p++;
                      }
                      j++;
                    }
  ...
  function(e, t, r) {
    ...
    var n = r(31),
      ...
      v = (0, a.default)(h.controlTemplate, y),
  ...
  function(e, t, r) {
    function o(e, t, r) {
      ...
      var S = t.variable;
      S || (O = 'with (obj) {\n' + O + '\n}\n'),
        (O = (M ? O.replace(h, '') : O).replace(y, '$1').replace(v, '$1;')),
        (O =
          'function(' +
          (S || 'obj') +
          ') {\n' +
